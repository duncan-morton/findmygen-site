      ...
      <div className="pb-4">
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">Who Are Gen X and Baby Boomers?</h2>
            ...
            <div className="bg-brand-soft border-l-4 border-brand p-6 my-8 rounded">
              <p className="text-slate-900 font-semibold mb-2">Quick Reference:</p>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Historical Context: Different Worlds</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Post-War Prosperity</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: The Latchkey Kids</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Work Ethic and Career Approach</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Company Loyalty</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Independent and Skeptical</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Technology Adoption: Analog to Digital</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Late Adopters</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: The Bridge Generation</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Communication Styles</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Formal and Hierarchical</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Direct and Efficient</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Parenting Approaches</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Permissive and Child-Centered</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Independent and Practical</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Money and Financial Attitudes</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Invest and Save</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Squeezed and Skeptical</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Social and Political Views</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Idealism to Pragmatism</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Cynical Moderates</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Cultural Touchstones</h2>

            <div className="bg-brand-soft border-l-4 border-brand p-6 my-8 rounded">
              <p className="text-slate-900 font-semibold mb-3">Baby Boomer Cultural Markers:</p>
            ...
            <div className="bg-brand-soft border-l-4 border-brand p-6 my-8 rounded">
              <p className="text-slate-900 font-semibold mb-3">Gen X Cultural Markers:</p>
              <ul className="space-y-1 text-slate-600 list-disc list-inside">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Retirement and Aging</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Redefining Retirement</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: The Forgotten Middle</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Where They Clash</h2>
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Want to discover your own generation? Try our <Link href="/quiz" className="text-brand hover:underline font-semibold">personality quiz</Link> or <Link href="/" className="text-brand hover:underline font-semibold">birth year calculator</Link> to see where you fit in generational history.
            </p>
