      ...
      <div className="pb-4">
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">Who is the Silent Generation?</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Why Silent?</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Growing Up During Crisis</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">The Great Depression</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">World War II</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Core Values and Characteristics</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Hard Work and Loyalty</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Financial Conservatism</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Respect for Authority</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Privacy and Formality</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Contributions and Achievements</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Civil Rights Movement</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Women in the Workforce</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Building Modern America</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Family and Relationships</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Traditional Family Structure</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Parenting Style</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Technology and Adaptation</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Retirement and Later Life</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Legacy and Impact</h2>
          ...
          <div className="mt-12 bg-gradient-to-r from-brand to-brand-strong rounded-2xl shadow-lg p-8 md:p-12 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/quiz"
                className="bg-white text-slate-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-100 transition-all shadow-lg"
              >
                Take the Quiz
              </Link>
              <Link 
                href="/"
                className="bg-slate-800 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-900 transition-all shadow-lg border-2 border-white"
              >
