      ...
      <div className="pb-4">
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">Who Are Gen Z and Millennials?</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Technology: Digital Immigrants vs Digital Natives</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: The Bridge Generation</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen Z: Born Into the Digital World</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Economic Reality: Optimism vs Pragmatism</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: The Recession Generation</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen Z: Realistic From the Start</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Work Values: Purpose vs Flexibility</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Finding Meaning in Work</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen Z: Work to Live, Not Live to Work</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Communication Styles: Different Digital Languages</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: The Email and Text Generation</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen Z: Video First, Text Second</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Social Issues: Different Approaches to Activism</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Awareness and Advocacy</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen Z: Action and Accountability</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Mental Health: From Stigma to Priority</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Cultural Touchstones: What Defines Each Generation</h2>
            ...
            <div className="bg-brand-soft border-l-4 border-brand p-6 my-8 rounded">
              <p className="text-slate-900 font-semibold mb-3">Gen Z Cultural Markers:</p>
              <ul className="space-y-1 text-slate-600 list-disc list-inside">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Want to discover which generation you truly belong to? Take our <Link href="/quiz" className="text-brand hover:underline font-semibold">personality quiz</Link> or use our <Link href="/" className="text-brand hover:underline font-semibold">birth year calculator</Link> to find out where you fit in generational history.
            </p>
