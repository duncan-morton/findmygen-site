      ...
      <div className="pb-4">
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">The Multi-Generational Workplace</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Understanding the Strengths of Each Generation</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Baby Boomers: Experience and Relationships</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Independence and Problem-Solving</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Collaboration and Purpose</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen Z: Digital Fluency and Authenticity</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Common Sources of Generational Conflict</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Communication Styles</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Work-Life Balance vs Work Ethic</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Feedback Expectations</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Practical Strategies for Bridging Gaps</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Create Communication Norms</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Implement Reverse Mentoring</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Focus on Results, Not Methods</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Build Cross-Generational Teams</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Address Stereotypes Directly</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">For Managers: Leading Multi-Generational Teams</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Flexible Management Approaches</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Recognition That Resonates</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Training and Development</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Creating an Inclusive Culture</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">The Business Case for Generational Diversity</h2>
