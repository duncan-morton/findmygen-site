      ...
      <div className="pb-4">
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-8 mb-4">Who Are Millennials and Gen X?</h2>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">The Workplace Divide</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Just Get It Done</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: But Why?</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Communication Styles: The Great Divide</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Email and Get to the Point</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Slack and Collaboration</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Feedback and Recognition</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: No News is Good News</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Feedback is Essential</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Work-Life Balance: Different Priorities</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Work Hard, Play Hard</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Work-Life Integration</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Career Paths and Loyalty</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Transactional and Pragmatic</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Purpose and Growth</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Technology and Change</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Adaptable Skeptics</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Digital Natives</h3>
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Money and Financial Stress</h2>

            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Gen X: Financially Squeezed</h3>
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-3">Millennials: Student Debt Burden</h3>
            ...
            <div className="bg-brand-soft border-l-4 border-brand p-6 my-8 rounded">
              <p className="text-slate-900 font-semibold mb-3">Millennial Cultural Markers:</p>
              <ul className="space-y-1 text-slate-600 list-disc list-inside">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Bridging the Gap</h2>
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Curious about your own generation? Take our <Link href="/quiz" className="text-brand hover:underline font-semibold">personality quiz</Link> or use our <Link href="/" className="text-brand hover:underline font-semibold">birth year calculator</Link> to discover where you fit in generational history.
            </p>
