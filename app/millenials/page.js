        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 leading-relaxed">
              Millennials, also known as Generation Y, include anyone born between <strong>1981 and 1996</strong>. This makes 
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              social media but adapted quickly to new technology. They grew up with dial-up internet, instant messaging (AIM, MSN), 
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              concerts, and activities over buying homes or expensive items. This generation coined the term YOLO (You Only Live Once) 
              and popularized sharing experiences on social media. Economic factors also play a role - many Millennials face 
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              their work to have purpose and meaning. They're known for job-hopping more than previous generations, seeking 
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mt-4">
              <li><strong>Purpose-driven work:</strong> Want to know their work matters</li>
              <li><strong>Feedback and growth:</strong> Expect regular communication and development opportunities</li>
              <li><strong>Flexibility:</strong> Remote work and flexible hours are priorities</li>
              <li><strong>Company culture:</strong> Will leave toxic environments regardless of pay</li>
              <li><strong>Work-life integration:</strong> Blur the lines between work and personal life but on their terms</li>
            </ul>

            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">Cultural Markers That Define Millennials</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li><strong>9/11 Terrorist Attacks:</strong> Defining moment that shaped their worldview</li>
              <li><strong>2008 Financial Crisis:</strong> Entered job market during recession, affected financial trajectory</li>
              <li><strong>Rise of Social Media:</strong> Facebook, Instagram, Twitter became part of daily life</li>
              <li><strong>iPhone Launch (2007):</strong> Smartphones changed everything during their young adult years</li>
              <li><strong>Student Debt Crisis:</strong> First generation to face massive education costs</li>
              <li><strong>Obama Election:</strong> First generation to vote for social media-savvy president</li>
              <li><strong>Sharing Economy:</strong> Uber, Airbnb, and gig work became mainstream</li>
            </ul>

            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">Millennial Stereotypes vs Reality</h2>
            <p className="text-gray-700 leading-relaxed">
              Millennials have been called entitled, lazy, and addicted to their phones. In reality, they're:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mt-4">
              ...
              <li>Dealing with economic challenges their parents didn't face (higher housing costs, student debt)</li>
            ...
            <div className="space-y-6 mt-6">
              ...
              <div>
                ...
                <p className="text-gray-700">Generation Z (Gen Z) comes after Millennials. Gen Z includes anyone born between 1997 and 2012.</p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">If I was born in 1995, am I a Millennial?</h3>
                <p className="text-gray-700">Yes, if you were born in 1995, you are a Millennial. You're on the younger end of the generation, close to the Gen Z cusp.</p>
              </div>

              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Why are they called Millennials?</h3>
                <p className="text-gray-700">They're called Millennials because they came of age around the turn of the millennium (year 2000). The oldest Millennials graduated high school in 1999, the youngest in 2014.</p>
              </div>
            </div>
          </div>
